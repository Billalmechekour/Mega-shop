...
"[project]/redux/storage.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const storage = ("TURBOPACK compile-time falsy", 0) ? ("TURBOPACK unreachable", undefined) : createNoopStorage();
const __TURBOPACK__default__export__ = storage;
}}),
"[project]/redux/features/products/productsSlice.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function jsonResponse(data, status = 200, headers) {
    return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["NextResponse"](JSON.stringify(data), {
        status,
        headers: {
...
"[project]/redux/features/carts/cartsSlice.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const cartsSlice = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createSlice"])({
    name: "carts",
    // `createSlice` will infer the state type from the `initialState` argument
    initialState,
    reducers: {
        addToCart: (state, action)=>{
            ...
            // check item in cart
            const isItemInCart = state.cart.items.find((item)=>action.payload.id === item.id && (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["compareArrays"])(action.payload.attributes, item.attributes));
            if (isItemInCart) {
                state.cart = {
                    ...state.cart,
                    items: state.cart.items.map((eachCartItem)=>{
                        if (eachCartItem.id === action.payload.id ? !(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["compareArrays"])(eachCartItem.attributes, isItemInCart.attributes) : eachCartItem.id !== action.payload.id) return eachCartItem;
                        return {
                            ...isItemInCart,
        ...
        remove: (state, action)=>{
            ...
            state.cart = {
                ...
                items: state.cart.items.filter((pItem)=>{
                    return pItem.id === action.payload.id ? !(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["compareArrays"])(pItem.attributes, isItemInCart.attributes) : pItem.id !== action.payload.id;
                }),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$redux$2f$storage$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/redux/storage.ts [app-ssr] (ecmascript)");
...
const persistConfig = {
    key: "root",
    storage: __TURBOPACK__imported__module__$5b$project$5d2f$redux$2f$storage$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"],
    version: 1,
    whitelist: [
        "carts"
    ]
...
const rootReducer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$redux$2f$dist$2f$redux$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["combineReducers"])({
    products: __TURBOPACK__imported__module__$5b$project$5d2f$redux$2f$features$2f$products$2f$productsSlice$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"],
    carts: __TURBOPACK__imported__module__$5b$project$5d2f$redux$2f$features$2f$carts$2f$cartsSlice$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"]
});
...
"[project]/components/ui/SpinnerLoader/SpinnerLoader.module.css [app-ssr] (css module)": ((__turbopack_context__) => {
...
"[project]/components/ui/SpinnerLoader/index.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react-jsx-dev-runtime.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$SpinnerLoader$2f$SpinnerLoader$2e$module$2e$css__$5b$app$2d$ssr$5d$__$28$css__module$29$__ = __turbopack_context__.i("[project]/components/ui/SpinnerLoader/SpinnerLoader.module.css [app-ssr] (css module)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$clsx$2f$dist$2f$clsx$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/clsx/dist/clsx.mjs [app-ssr] (ecmascript)");
;
;
;
const SpinnerLoader = ({ className })=>{
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$clsx$2f$dist$2f$clsx$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$SpinnerLoader$2f$SpinnerLoader$2e$module$2e$css__$5b$app$2d$ssr$5d$__$28$css__module$29$__["default"].Loader, {}, className && className)
    }, void 0, false, {
...
// UI components
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$SpinnerLoader$2f$index$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/ui/SpinnerLoader/index.tsx [app-ssr] (ecmascript)");
"use client";
;
;
;
...
const Providers = ({ children, session })=>{
    const { store, persistor } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$redux$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["makeStore"])();
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$redux$2f$dist$2f$react$2d$redux$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Provider"], {
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$redux$2d$persist$2f$es$2f$integration$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["PersistGate"], {
                loading: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$SpinnerLoader$2f$index$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__99e6dd61._.js.map