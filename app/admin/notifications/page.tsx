...
import { Bell, Check, Eye, Trash2, AlertTriangle, ShoppingCart, Star, Calendar } from "lucide-react";
...
export default function NotificationsPage() {
  ...
  const [typeFilter, setTypeFilter] = useState<"Signalement" | "Commande" | "Évaluation" | "">("");
            ...
            <div className="relative w-full sm:w-32">
              ...
              {isTypeOpen && (
                ...
                >
                  ...
                  <button
                    onClick={() => { setTypeFilter("Signalement"); setIsTypeOpen(false); }}
                    className="w-full px-4 py-2 text-gray-800 text-sm hover:bg-gray-100 transition-all duration-200"
                  >
                    Signalement
                  </button>
