  ...
  if (active && payload && payload.length) {
    return (
      <div className="bg-white/95 backdrop-blur-md p-3 sm:p-4 rounded-xl shadow-xl border border-gray-200">
        <p className="text-xs sm:text-sm font-semibold text-gray-800 mb-2">{label}</p>
        ...
        <div key={index} className="flex items-center gap-2">
          <div className="flex items-center gap-1">
            <div
              ...
              style={{ background: `linear-gradient(to right, ${entry.color}, ${entry.color}80)` }}
            ></div>
            <div
          ...
          <div className="bg-black rounded-2xl p-6 sm:p-8 text-white shadow-xl relative overflow-hidden transition-all hover:shadow-2xl transform hover:-translate-y-1 h-auto sm:h-48">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4 sm:gap-6 h-full">
              <div className="text-center sm:text-left">
                <h1 className={`welcome-text text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight ${montserrat.className} relative z-10`}>
                  Bienvenue,
                </h1>
                <p className={`name-text text-lg sm:text-xl mt-2 sm:mt-4 ${montserrat.className}`}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
            <div className="data-card bg-white rounded-xl shadow-lg p-3 sm:p-4 border-2 border-green-500 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 hover:bg-green-50 hover:border-green-600 h-[72px] sm:h-[84px] flex items-center">
              <div className="flex items-center gap-2 sm:gap-3 w-full">
                ...
                <div className="flex-1">
                  <h3 className="text-xs sm:text-sm font-medium text-gray-600">Total des ventes</h3>
                  <p className="text-base sm:text-lg font-bold text-gray-900">{stats.totalSales.toLocaleString()} DZD</p>
                </div>
              </div>
            </div>
            ...
            <div className="data-card bg-white rounded-xl shadow-lg p-3 sm:p-4 border-2 border-blue-500 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 hover:bg-blue-50 hover:border-blue-600 h-[72px] sm:h-[84px] flex items-center">
              <div className="flex items-center gap-2 sm:gap-3 w-full">
                ...
                <div className="flex-1">
                  <h3 className="text-xs sm:text-sm font-medium text-gray-600">Total des produits</h3>
                  <p className="text-base sm:text-lg font-bold text-gray-900">{stats.totalProducts} produits</p>
                  <p className="text-[10px] sm:text-xs text-gray-500">{stats.totalItems} articles au total</p>
                </div>
              </div>
            </div>
            ...
            <div className="data-card bg-white rounded-xl shadow-lg p-3 sm:p-4 border-2 border-teal-500 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 hover:bg-teal-50 hover:border-teal-600 h-[72px] sm:h-[84px] flex items-center">
              <div className="flex items-center gap-2 sm:gap-3 w-full">
                ...
                <div className="flex-1">
                  <h3 className="text-xs sm:text-sm font-medium text-gray-600">Produits vendus</h3>
                  <p className="text-base sm:text-lg font-bold text-gray-900">{stats.soldProducts.products} produits</p>
                  <p className="text-[10px] sm:text-xs text-gray-500">{stats.soldProducts.items} articles vendus</p>
                </div>
              </div>
            </div>
            ...
            <div className="data-card bg-white rounded-xl shadow-lg p-3 sm:p-4 border-2 border-yellow-500 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 hover:bg-yellow-50 hover:border-yellow-600 h-[72px] sm:h-[84px] flex items-center">
              <div className="flex items-center gap-2 sm:gap-3 w-full">
                ...
                <div className="flex-1">
                  <h3 className="text-xs sm:text-sm font-medium text-gray-600">Produit le plus rentable</h3>
                  <p className="text-base sm:text-lg font-bold text-gray-900">{stats.mostProfitableProduct.name}</p>
                  <p className="text-[10px] sm:text-xs text-gray-500">{stats.mostProfitableProduct.profit.toLocaleString()} DZD de bénéfice</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="data-card bg-white rounded-xl shadow-lg p-3 sm:p-4 border-2 border-purple-500 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 hover:bg-purple-50 hover:border-purple-600">
            <div className="flex items-center justify-between gap-2 sm:gap-3">
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <div>
                  <h3 className="text-xs sm:text-sm font-medium text-gray-600">Meilleure note produit</h3>
                  <p className="text-lg sm:text-xl font-bold text-gray-900">{stats.productRatings.highest.name}</p>
                  <p className="text-xs sm:text-sm text-gray-500">{stats.productRatings.highest.rating}/5 ({stats.productRatings.highest.reviews} avis)</p>
                </div>
              </div>
              <div className="flex items-center">
                {renderStars(stats.productRatings.highest.rating, "text-purple-500 fill-purple-500")}
              </div>
            </div>
          </div>
          ...
          <div className="data-card bg-white rounded-xl shadow-lg p-3 sm:p-4 border-2 border-red-500 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 hover:bg-red-50 hover:border-red-600">
            <div className="flex items-center justify-between gap-2 sm:gap-3">
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <div>
                  <h3 className="text-xs sm:text-sm font-medium text-gray-600">Pire note produit</h3>
                  <p className="text-lg sm:text-xl font-bold text-gray-900">{stats.productRatings.lowest.name}</p>
                  <p className="text-xs sm:text-sm text-gray-500">{stats.productRatings.lowest.rating}/5 ({stats.productRatings.lowest.reviews} avis)</p>
                </div>
              </div>
              <div className="flex items-center">
                {renderStars(stats.productRatings.lowest.rating, "text-red-500 fill-red-500")}
              </div>
            </div>
          </div>
        </div>
              ...
              {chartType === "line" ? (
                ...
                >
                  ...
                  <XAxis
                    dataKey={xAxisKey}
                    stroke="#1F2937"
                    tick={{ fontSize: 10, fontFamily: "Montserrat", fill: "#1F2937" }}
                    interval={0}
                  />
                  <YAxis
                    yAxisId="left"
