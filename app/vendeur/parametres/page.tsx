...
import { ArrowLeft, Camera, CreditCard, User, Shield, MapPin, Phone, Settings as SettingsIcon } from "lucide-react";
...
export default function SettingsPage() {
  ...
  const handleDeleteStore = () => {
    ...
    setTimeout(() => {
      ...
      setSellerInfo({ businessName: "", accountNumber: "", bankName: "", taxId: "" });
          ...
          <div className="space-y-6">
            ...
            {activeTab === "personal" && (
              <div className="bg-white rounded-xl shadow-lg p-6">
                ...
                <p className="text-sm text-gray-600 mb-6">Mettez à jour vos informations personnelles.</p>
            ...
            {activeTab === "address" && (
              <div className="bg-white rounded-xl shadow-lg p-6">
                ...
                <p className="text-sm text-gray-600 mb-6">Mettez à jour votre adresse de livraison.</p>
                        ...
                        {isProvinceDropdownOpen && (
                          <ul className="absolute z-10 w-full bg-white border border-gray-200 rounded-lg max-h-60 overflow-y-auto shadow-lg">
                            {filteredProvinces.length > 0 ? (
                              ...
                              <li className="px-4 py-2 text-gray-500">Aucune province trouvée</li>
                            )}
                          </ul>
                        )}
                      </div>
            ...
            {activeTab === "contact" && (
              <div className="bg-white rounded-xl shadow-lg p-6">
                ...
                <p className="text-sm text-gray-600 mb-6">Mettez à jour vos informations de contact.</p>
                <form onSubmit={handleContactSubmit} className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-black focus:border-black transition-all duration-200 text-gray-800"
                    />
                    <p className="text-xs text-gray-500 mt-1">Utilisé pour les notifications de commande</p>
                  </div>
                  <button
                    type="submit"
                    className="bg-black text-white px-6 py-3 rounded-lg hover:bg-gray-800 transition-all duration-300 shadow-md disabled:opacity-50"
            ...
            {activeTab === "security" && (
              <div className="bg-white rounded-xl shadow-lg p-6">
                ...
                <p className="text-sm text-gray-600 mb-6">Mettez à jour votre mot de passe pour sécuriser votre compte.</p>
              ...
              <div className="bg-white rounded-xl shadow-lg p-6">
                <div className="flex justify-between items-center mb-6">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Configurez les informations de votre boutique.</p>
                  </div>
                  {isSellerActive && (
                    <button
                ...
                <form onSubmit={handleSellerSubmit} className="space-y-6">
                  <div className="space-y-2">
                    <label htmlFor="businessName" className="block text-sm font-medium text-gray-700">Nom de l’entreprise</label>
                    <input
                      id="businessName"
                      name="businessName"
                  ...
                  <div className="space-y-2">
                    <label htmlFor="accountNumber" className="block text-sm font-medium text-gray-700">Numéro de compte bancaire</label>
                    <input
                      id="accountNumber"
                      name="accountNumber"
                  ...
                  <div className="space-y-2">
                    <label htmlFor="taxId" className="block text-sm font-medium text-gray-700">Identifiant fiscal (optionnel)</label>
                    <input
                      id="taxId"
                      name="taxId"
                  ...
                  <div className="flex gap-4">
                    <button
                      ...
                      disabled={isLoading}
                    >
                      {isLoading ? "Enregistrement..." : isSellerActive ? "Mettre à jour" : "Activer le statut vendeur"}
                    </button>
                  </div>
                </form>
              </div>
